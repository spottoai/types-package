...
export type PortfolioCustomerSortField = 'customerName' | 'subscriptionCount' | 'readySubscriptionCount' | 'cloudAccountCount' | 'averageSecureScore' | 'averageAdvisorScore' | 'lastUpdated';
...
export type PortfolioBudgetSortField = 'customerName' | 'subscriptionName' | 'budgetName' | 'status' | 'actualPercent' | 'forecastPercent' | 'endDate';
...
//# sourceMappingURL=portfolioOperations.d.ts.map