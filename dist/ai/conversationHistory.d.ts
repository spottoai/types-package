...
export declare const AI_CHAT_HISTORY_ARTIFACT_LIMITS_V1: Readonly<{
    readonly responseArtifactsPerConversation: 100;
    readonly citationsPerResponse: 50;
    readonly workspaceArtifactSummariesPerResponse: 5;
}>;
