...
export const projectFinancialSavingsResourceV1 = (savingsAuthority, financialProjection, financialAuthority, chargeInclusionPolicyRef = AZURE_BILLED_ALL_CHARGES_POLICY_V1.policyRef) => {
    ...
    const coordinates = financialProjection.coordinates.map(financialCoordinate => {
        ...
        const selectedAllocations = resourceAllocations.filter(allocation => {
            if (chargeInclusionPolicyRef.policyId === AZURE_BILLED_ALL_CHARGES_POLICY_V1.policyRef.policyId &&
