...
export const isRawArtifactRunIdV1 = (value) => {
...
export const encodeArtifactRunReferenceV1 = (rawRunId) => {
...
export const isArtifactRunReferenceV1 = (value) => typeof value === 'string' &&
