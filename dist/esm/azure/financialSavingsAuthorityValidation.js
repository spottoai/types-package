    ...
    if (!hasExactFinancialSavingsFields(value, [
        ...
        (value.displayMemberResourceContributions !== undefined &&
            (!Array.isArray(value.displayMemberResourceContributions) ||
                ...
                !value.displayMemberResourceContributions.every(contribution => isFinancialSavingsRecord(contribution) &&
        ...
        (value.displayMemberRecommendationContributions !== undefined &&
            (!Array.isArray(value.displayMemberRecommendationContributions) ||
                ...
                !value.displayMemberRecommendationContributions.every(contribution => isFinancialSavingsRecord(contribution) &&
