...
export const isFinancialAuthorityComponentDescriptorV1 = (value) => {
    if (!isRecord(value) ||
...
export const createFinancialDisplayRollupIdV1 = (value) => `sha256:${sha256Utf8(JSON.stringify(canonicalRollupPreimage(value)))}`;
export const isFinancialDisplayRollupV1 = (value) => {
    if (!isRecord(value) ||
