...
export const createFinancialSavingsSurfaceProjectionIdV1 = (value) => `sha256:${sha256Utf8(canonicalizeFinancialSavingsSurfaceProjectionIdentityV1(value))}`;
...
const isCoordinateCommon = (value) => isFinancialSavingsHash(value.coordinateId) &&
...
const isUnavailableCoordinate = (value) => hasExactFinancialSavingsFields(value, ['status', 'coordinateId', 'periodRole', 'period', 'costBasis', 'estimateLens', 'chargeInclusionPolicyRef', 'unavailableReason'], ['requestedCurrencyCode', 'currentAggregateBaselineId']) &&
    isCoordinateCommon(value) &&
    typeof value.unavailableReason === 'string' &&
    UNAVAILABLE_REASONS.has(value.unavailableReason);
export const isFinancialSavingsSurfaceProjectionV1 = (value) => {
    if (!isFinancialSavingsRecord(value) ||
