...
import { FINANCIAL_EVIDENCE_BUNDLE_CONTRACT_VERSION_V1, } from './financialScopeEvidence.js';
import { FINANCIAL_SCOPE_BASELINE_CONTRACT_VERSION_V2, FINANCIAL_SCOPE_BASELINE_SCHEMA_VERSION_V2, FINANCIAL_SCOPE_BASELINE_UNAVAILABLE_REASONS_V2, } from './financialScopeBaseline.js';
import { canonicalizeValidatedFinancialEvidenceBundleIdentityV1, canonicalizeValidatedFinancialScopeBaselineIdentityV2, } from './financialScopeBaselineIdentity.js';
...
const UNAVAILABLE_REASONS = new Set(FINANCIAL_SCOPE_BASELINE_UNAVAILABLE_REASONS_V2);
...
export const isFinancialEvidenceBundleIdentityPreimageV1 = (value) => isRecord(value) &&
...
export const canonicalizeFinancialEvidenceBundleIdentityV1 = (value) => {
...
export const isFinancialEvidenceBundleV1 = (value) => {
...
export const isFinancialBaselinePeriodV2 = (value) => {
    if (!isRecord(value) ||
...
const isCommonBaseline = (value) => value.schemaVersion === FINANCIAL_SCOPE_BASELINE_SCHEMA_VERSION_V2 &&
...
export const canonicalizeFinancialScopeBaselineIdentityV2 = (value) => {
...
const exactSum = (values) => formatExactDecimalValue(sumCanonicalDecimals(values));
const isAvailableOwner = (value) => {
    ...
    if (componentTotal !== total.amount ||
        ...
        ![reconciliation.sourceTotal, reconciliation.withheldTotal, reconciliation.residualTotal].every(amount => isCanonicalExactMoney({ amount, currencyCode: total.currencyCode })) ||
...
export const isFinancialScopeBaselineEnvelopeV2 = (value) => isRecord(value) && isCommonBaseline(value) && (isAvailableOwner(value) || isAvailableAggregate(value) || isUnavailable(value));
