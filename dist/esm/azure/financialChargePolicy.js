export const AZURE_CLOUD_SERVICES_EXCLUDING_MARKETPLACE_POLICY_REF_V1 = 'azure-cloud-services-excluding-marketplace/v1';
...
export const isAzurePublisherTypeEvidenceV1 = (value) => {
...
export const isAzureFinancialChargeClassificationV1 = (value) => {
...
export const isAzureFinancialCoordinateV1 = (value) => {
    if (!isRecord(value) ||
...
export const isAzureFinancialChargeCoverageV1 = (value) => {
    if (!isRecord(value) ||
...
export const isAzurePolicyBoundSavingsAggregateV1 = (value) => {
    if (!isRecord(value) ||
...
export const isAzureChargeableSavingsV1 = (value) => {
    if (!isRecord(value) ||
        value.contractVersion !== 'financial-charge-policy/v1' ||
        value.policyRef !== AZURE_CLOUD_SERVICES_EXCLUDING_MARKETPLACE_POLICY_REF_V1 ||
        !isAzureFinancialCoordinateV1(value.coordinate) ||
...
export const isAzureCompanyChargeableSavingsResponseV1 = (value) => {
    if (!isRecord(value) ||
