...
export function sha256(value, field) {
...
export function optionalEnum(value, values, field) {
    if (value !== undefined)
        requiredEnum(value, values, field);
}
export function optionalRecord(value, field) {
    if (value !== undefined)
...
export function assertNoForbiddenKeys(value, field) {
    if (Array.isArray(value)) {
...
export function assertPublicJson(value, field) {
...
export function assertRequiredKeys(value, required, field) {
...
export function assertJsonEqual(actual, expected, field) {
    if (JSON.stringify(actual) !== JSON.stringify(expected))
        throw new Error(`${field} must match its exact binding.`);
}
export function validateDescriptor(value, field) {
...
export function validateBilling(value, field = 'target.billing') {
...
export function validateSelector(value, field) {
...
export function validateMetricWindow(value, field) {
...
export function validateTagRuleScope(value) {
    if (value === undefined)
        return;
