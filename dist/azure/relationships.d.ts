...
export declare const RELATIONSHIP_GRAPH_MANIFEST_SCHEMA_VERSION = 1;
export declare const RELATIONSHIP_GRAPH_INDEX_SCHEMA_VERSION = 1;
...
export type RelationshipSubgraphViewMode = 'architectural' | 'network' | 'security' | 'cost' | 'relationships' | 'resource-detail' | 'overview';
...
export type RelationshipSubgraphSummaryKind = 'hiddenChildren' | 'hiddenEdges' | 'resourceTypeGroup' | 'resourceGroup' | 'networkGroup' | 'externalReferences';
