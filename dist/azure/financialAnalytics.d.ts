...
export declare const FINANCIAL_ANALYTICS_INPUT_CONTRACT_VERSION_V1: "financial-analytics-input/v1";
export declare const FINANCIAL_ANALYTICS_PROJECTION_CONTRACT_VERSION_V1: "financial-analytics-projection/v1";
...
export type FinancialAnalyticsInputCoordinateV1 = FinancialDataflowCoordinateV1 & {
    ...
    period: FinancialDataflowCoordinateV1['period'] & {
...
export type FinancialAnalyticsDisplayPeriodKeyV1 = 'last-7-days' | 'rolling-30-days' | 'rolling-90-days' | 'trailing-12-calendar-months';
...
export type FinancialAnalyticsDisplayProjectionV1 = (FinancialAnalyticsDisplayProjectionCommonV1 & {
    status: 'available';
    amount: string;
    averageKnownPerDay: string;
    knownAmount?: never;
...
type FinancialAnalyticsAvailableInputBindingV1 = {
    analyticsInputId: string;
    currentSpendCompositionId: string;
    result: FinancialForecastResultV1;
} | {
    analyticsInputId: string;
    currentSpendCompositionId: string;
    result: FinancialTrendResultV1;
} | {
    analyticsInputId: string;
    currentSpendCompositionId: string;
    result: FinancialAnomalyResultV1;
};
export type AvailableFinancialAnalyticsProjectionV1 = FinancialAnalyticsProjectionCommonV1 & FinancialAnalyticsAvailableInputBindingV1 & {
    status: 'available';
    reasonCodes?: never;
    resultKind?: never;
};
export type PartialFinancialAnalyticsProjectionV1 = FinancialAnalyticsProjectionCommonV1 & FinancialAnalyticsAvailableInputBindingV1 & {
    status: 'partial';
    reasonCodes: [string, ...string[]];
    resultKind?: never;
};
...
export type FinancialAnalyticsProjectionV1 = AvailableFinancialAnalyticsProjectionV1 | PartialFinancialAnalyticsProjectionV1 | UnavailableFinancialAnalyticsProjectionV1;
export type FinancialAnalyticsProjectionIdentityPreimageV1 = FinancialAnalyticsProjectionV1 extends infer Projection ? Projection extends FinancialAnalyticsProjectionV1 ? Omit<Projection, 'analyticsProjectionId'> : never : never;
export {};
//# sourceMappingURL=financialAnalytics.d.ts.map