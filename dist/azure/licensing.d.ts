...
export type LicensingServiceModel = 'virtual-machine' | 'virtual-machine-scale-set' | 'sql-virtual-machine' | 'sql-database' | 'sql-elastic-pool' | 'sql-managed-instance' | 'unknown';
...
export interface LicensingSummary {
    ...
    byProductFamily?: Array<{
        productFamily: LicensingProductFamily;
        count: number;
    }>;
    byServiceModel?: Array<{
        serviceModel: LicensingServiceModel;
        count: number;
    }>;
