...
export declare const WORK_ITEM_LANES: readonly ["prioritized", "todo", "in-progress", "completed"];
export declare const DEFAULT_WORK_BOARD_ID = "kanban";
export declare const WORK_ITEM_EXTERNAL_TICKET_PROVIDERS: readonly ["jira", "halo", "connectwise", "autotask", "azuredevops", "github"];
export declare const WORK_ITEM_SHARE_CHANNELS: readonly ["email", "jira", "halo", "connectwise", "autotask", "azuredevops", "github"];
export type WorkItemLane = (typeof WORK_ITEM_LANES)[number];
export type WorkItemSourceType = 'recommendation' | 'service-retirement' | 'resource' | 'backup' | 'commitments-purchase-recommendation' | 'commitments-renewal' | 'governance-finding' | 'governance-policy-assignment' | 'governance-policy-exemption' | 'governance-rbac-assignment' | 'governance-privileged-assignment' | 'governance-custom-role' | 'perimeter-public-ip' | 'health-event' | 'hybrid-benefit' | 'change-activity' | 'review-checklist-item' | 'alert-instance' | 'collection';
...
//# sourceMappingURL=workManagement.d.ts.map