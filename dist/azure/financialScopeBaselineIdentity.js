...
exports.canonicalizeValidatedFinancialScopeBaselineIdentityV2 = exports.canonicalizeValidatedFinancialEvidenceAssessmentIdentityV1 = exports.canonicalizeValidatedFinancialEvidenceBundleIdentityV1 = void 0;
...
const canonicalizeValidatedFinancialEvidenceBundleIdentityV1 = (value) => JSON.stringify({
...
exports.canonicalizeValidatedFinancialEvidenceBundleIdentityV1 = canonicalizeValidatedFinancialEvidenceBundleIdentityV1;
/** Canonical UTF-8 text for a validated evidence-assessment identity. */
const canonicalizeValidatedFinancialEvidenceAssessmentIdentityV1 = (value) => JSON.stringify({
    schemaVersion: value.schemaVersion,
    contractVersion: value.contractVersion,
...
exports.canonicalizeValidatedFinancialEvidenceAssessmentIdentityV1 = canonicalizeValidatedFinancialEvidenceAssessmentIdentityV1;
...
const canonicalizeValidatedFinancialScopeBaselineIdentityV2 = (value) => {
    const common = {
        schemaVersion: value.schemaVersion,
        contractVersion: value.contractVersion,
...
exports.canonicalizeValidatedFinancialScopeBaselineIdentityV2 = canonicalizeValidatedFinancialScopeBaselineIdentityV2;
//# sourceMappingURL=financialScopeBaselineIdentity.js.map