...
exports.buildFinancialSavingsSurfaceProjectionV1 = exports.projectFinancialSavingsSurfaceResourceQueryV1 = exports.projectFinancialSavingsSurfaceQueryV1 = exports.FinancialSavingsSurfaceProjectionError = void 0;
...
exports.FinancialSavingsSurfaceProjectionError = FinancialSavingsSurfaceProjectionError;
...
const selectAggregateForPolicy = (financialCoordinate, policyRef, chargeCompositionByBaselineId) => {
    if (financialCoordinate.aggregateBaseline.status !== 'available')
        return undefined;
    if (samePolicy(policyRef, financialChargeComposition_1.AZURE_BILLED_ALL_CHARGES_POLICY_V1.policyRef)) {
    ...
    if (compositions.length !== memberIds.size)
        return undefined;
    const selections = compositions.map(composition => (0, financialChargeCompositionValidation_1.selectFinancialChargesV1)(composition, policyRef));
    if (selections.some(selection => selection.status !== 'available'))
        return undefined;
    return (0, exactDecimal_1.formatExactDecimalValue)((0, exactDecimal_1.sumCanonicalDecimals)(selections.map(selection => selection.includedAmount)));
};
...
const projectFinancialSavingsSurfaceQueryV1 = (source, recommendationIds, filterFingerprint) => {
    ...
    const projection = {
        ...identity,
        projectionId: (0, financialSavingsSurfaceProjectionValidation_1.createFinancialSavingsSurfaceProjectionIdV1)(identity),
    };
    if (!(0, financialSavingsSurfaceProjectionValidation_1.isFinancialSavingsSurfaceProjectionV1)(projection)) {
        throw new FinancialSavingsSurfaceProjectionError('Financial savings query projection failed validation');
    }
    return projection;
};
exports.projectFinancialSavingsSurfaceQueryV1 = projectFinancialSavingsSurfaceQueryV1;
...
const projectFinancialSavingsSurfaceResourceQueryV1 = (source, allocationIds, recommendationIds, filterFingerprint) => {
    if (!(0, financialSavingsSurfaceProjectionValidation_1.isFinancialSavingsSurfaceProjectionV1)(source) || source.surface !== 'resources') {
    ...
    const projection = { ...identity, projectionId: (0, financialSavingsSurfaceProjectionValidation_1.createFinancialSavingsSurfaceProjectionIdV1)(identity) };
    if (!(0, financialSavingsSurfaceProjectionValidation_1.isFinancialSavingsSurfaceProjectionV1)(projection)) {
        throw new FinancialSavingsSurfaceProjectionError('Financial savings resource query projection failed validation');
    }
    return projection;
};
exports.projectFinancialSavingsSurfaceResourceQueryV1 = projectFinancialSavingsSurfaceResourceQueryV1;
/**
...
const buildFinancialSavingsSurfaceProjectionV1 = (resourcesView, surface, chargeInclusionPolicyRef = financialChargeComposition_1.AZURE_BILLED_ALL_CHARGES_POLICY_V1.policyRef) => {
    ...
    const coordinates = authority.coordinates.map((financialCoordinate) => {
        ...
        const selectedAllocations = samePolicy(chargeInclusionPolicyRef, financialChargeComposition_1.AZURE_BILLED_ALL_CHARGES_POLICY_V1.policyRef)
    ...
    const identity = {
        schemaVersion: financialSavingsSurfaceProjection_1.FINANCIAL_SAVINGS_SURFACE_PROJECTION_SCHEMA_VERSION_V1,
        contractVersion: financialSavingsSurfaceProjection_1.FINANCIAL_SAVINGS_SURFACE_PROJECTION_CONTRACT_VERSION_V1,
        surface,
...
exports.buildFinancialSavingsSurfaceProjectionV1 = buildFinancialSavingsSurfaceProjectionV1;
//# sourceMappingURL=financialSavingsSurfaceProjectionKernel.js.map