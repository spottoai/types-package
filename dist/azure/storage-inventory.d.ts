...
export type InventoryAnalysisErrorCode = 'inventory_analysis_not_found' | 'inventory_input_missing' | 'inventory_manifest_missing' | 'inventory_manifest_invalid' | 'inventory_manifest_account_mismatch' | 'inventory_manifest_empty' | 'inventory_data_file_missing' | 'inventory_analysis_failed';
