...
export type PublicIpAddressesExposureSourceKind = 'internet' | 'restricted_public' | 'private' | 'service_tag' | 'application_security_group' | 'unknown';
...
export type PublicIpAddressesRemediationOptionKind = 'azure_bastion' | 'vpn_gateway' | 'jit_vm_access' | 'azure_virtual_desktop' | 'cloudflare_tunnel' | 'restrict_nsg_allowlist' | 'remove_public_ip' | 'front_with_app_gateway_waf' | 'document_exception';
