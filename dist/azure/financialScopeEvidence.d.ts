...
export type FinancialScopeKindV2 = 'canonical-resource-owner' | 'composite-resource' | 'commitment-instrument' | 'subscription-residual' | 'subscription-aggregate' | 'portfolio-currency-group';
...
export type FinancialEvidenceAssessmentReasonV1 = 'evidence-accepted' | 'evidence-not-produced' | 'evidence-not-matched' | 'evidence-incomplete' | 'evidence-stale' | 'reconciliation-failed' | 'currency-unresolved' | 'currency-conflicting' | 'ownership-unresolved' | 'unsupported-scope';
...
//# sourceMappingURL=financialScopeEvidence.d.ts.map