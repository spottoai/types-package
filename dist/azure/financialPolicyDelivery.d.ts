import type { FinancialPolicyCoordinateRequestV1, FinancialPolicyCriteriaV1, FinancialPolicyEvaluationResultV1, FinancialPolicyMatchedThresholdV1, FinancialPolicySignalKindV1 } from './financialPolicy';
...
export declare const FINANCIAL_POLICY_DEFINITION_COMMAND_CONTRACT_VERSION_V1: "financial-policy-definition-command/v1";
export declare const FINANCIAL_POLICY_READ_CURRENT_POINTER_CONTRACT_VERSION_V1: "financial-policy-read-current-pointer/v1";
export declare const FINANCIAL_POLICY_ACTION_COMPLETION_CONTRACT_VERSION_V1: "financial-policy-action-completion/v1";
export declare const FINANCIAL_POLICY_READ_MANIFEST_CONTRACT_VERSION_V1: "financial-policy-read-manifest/v1";
...
export type FinancialPolicyEvaluationReadCurrentPointerIdentityPreimageV1 = Omit<FinancialPolicyEvaluationReadCurrentPointerV1, 'pointerDigest'>;
...
export type FinancialPolicyEvaluationReadManifestIdentityPreimageV1 = Omit<FinancialPolicyEvaluationReadManifestV1, 'manifestDigest'>;
