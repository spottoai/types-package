...
exports.isFinancialEvidenceAssessmentV1 = exports.canonicalizeFinancialEvidenceAssessmentIdentityV1 = void 0;
...
const isAssessmentIdentity = (value) => {
    if (!isRecord(value) ||
        ...
        value.contractVersion !== financialScopeEvidence_1.FINANCIAL_EVIDENCE_ASSESSMENT_CONTRACT_VERSION_V1 ||
...
const canonicalizeFinancialEvidenceAssessmentIdentityV1 = (value) => {
    if (!isAssessmentIdentity(value))
        throw new TypeError('Invalid FinancialEvidenceAssessmentIdentityPreimageV1.');
    return (0, financialScopeBaselineIdentity_1.canonicalizeValidatedFinancialEvidenceAssessmentIdentityV1)(value);
};
exports.canonicalizeFinancialEvidenceAssessmentIdentityV1 = canonicalizeFinancialEvidenceAssessmentIdentityV1;
const isFinancialEvidenceAssessmentV1 = (value) => {
    ...
    return (typeof assessmentId === 'string' &&
        ...
        assessmentId === `sha256:${(0, sha256_1.sha256Utf8)((0, financialScopeBaselineIdentity_1.canonicalizeValidatedFinancialEvidenceAssessmentIdentityV1)(identity))}`);
};
exports.isFinancialEvidenceAssessmentV1 = isFinancialEvidenceAssessmentV1;
//# sourceMappingURL=financialEvidenceAssessmentValidation.js.map