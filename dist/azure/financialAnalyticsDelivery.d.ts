...
export declare const FINANCIAL_ANALYTICS_INPUT_BY_ID_ROOT_V1: "financial-analytics/inputs-by-id";
export declare const FINANCIAL_ANALYTICS_PROJECTION_LOGICAL_NAME_V1: "financial-analytics-projection.json.gz";
export declare const FINANCIAL_ANALYTICS_BATCH_QUERY_CONTRACT_VERSION_V1: "financial-analytics-batch-query/v1";
export declare const FINANCIAL_ANALYTICS_BATCH_RESPONSE_CONTRACT_VERSION_V1: "financial-analytics-batch-response/v1";
export declare const FINANCIAL_ANALYTICS_OUTPUT_MANIFEST_CONTRACT_VERSION_V1: "financial-analytics-output-manifest/v1";
export declare const financialAnalyticsInputByIdPathV1: (analyticsInputId: string) => string;
export type FinancialAnalyticsRequestedOutputV1 = {
    resultKind: 'forecast';
    targetCoordinate: FinancialDataflowCoordinateV1 & {
...
export type FinancialAnalyticsBatchResultV1 = (FinancialAnalyticsBatchQueryItemV1 & {
    status: 'available';
