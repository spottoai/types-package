...
export type RecommendationWorkflowSystemTrackResourceItem = RecommendationWorkflowItemBase & RecommendationWorkflowSystemTrackResourceOrigin & RecommendationWorkflowSelectedSubsetSelection & RecommendationWorkflowLaneState;
...
export declare const RECOMMENDATION_SYSTEM_TRACK_RECONCILIATION_PAGE_LIMIT: 250;
...
type RecommendationSystemTrackActiveReconciliationResponse = RecommendationSystemTrackReconciliationCounts & (RecommendationSystemTrackReconciliationCompletePage | RecommendationSystemTrackReconciliationContinuedPage) & {
    result: 'changed' | 'no-op';
};
type RecommendationSystemTrackStaleReconciliationResponse = RecommendationSystemTrackReconciliationCounts & RecommendationSystemTrackReconciliationCompletePage & {
    result: 'stale-run-no-op';
};
export type RecommendationSystemTrackReconciliationResponse = RecommendationSystemTrackActiveReconciliationResponse | RecommendationSystemTrackStaleReconciliationResponse;
export {};
