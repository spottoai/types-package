...
export declare function isScheduleProjection(value: unknown): value is ScheduleProjection;
export declare function isScheduleListResponse(value: unknown): value is ScheduleListResponse;
export declare function isScheduledRecommendationActionV1(value: unknown): value is ScheduledRecommendationActionV1;
export declare function isScheduledOccurrenceV1(value: unknown): value is ScheduledOccurrenceV1;
export declare function isSchedulerControlRequestMessageV1(value: unknown): value is SchedulerControlRequestMessageV1;
export declare function isSchedulerOperationAcceptedResponse(value: unknown): value is SchedulerOperationAcceptedResponse;
export declare function isSchedulerOperationProjection(value: unknown): value is SchedulerOperationProjection;
//# sourceMappingURL=schedulerValidation.d.ts.map