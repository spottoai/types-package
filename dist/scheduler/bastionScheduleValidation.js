...
exports.isBastionAvailabilityWeeklyScheduleWriteRequest = isBastionAvailabilityWeeklyScheduleWriteRequest;
exports.isBastionAvailabilityWeeklyScheduleDefinition = isBastionAvailabilityWeeklyScheduleDefinition;
exports.isBastionScheduleRun = isBastionScheduleRun;
exports.isBastionScheduleControlV1 = isBastionScheduleControlV1;
exports.isBastionScheduleReadinessV1 = isBastionScheduleReadinessV1;
exports.isBastionAvailabilityStatusV1 = isBastionAvailabilityStatusV1;
exports.isBastionPauseResponse = isBastionPauseResponse;
exports.isBastionRestoreNowResponse = isBastionRestoreNowResponse;
...
function isBastionAvailabilityWeeklyScheduleWriteRequest(value) {
...
function isBastionAvailabilityWeeklyScheduleDefinition(value) {
...
function isBastionScheduleControlV1(value) {
...
function isBastionScheduleReadinessV1(value) {
    if (!isWithinJsonSize(value, MAX_PUBLIC_DTO_BYTES) ||
...
function isBastionAvailabilityStatusV1(value) {
    return (isWithinJsonSize(value, MAX_PUBLIC_DTO_BYTES) &&
        hasExactFields(value, [
            'schemaVersion',
            'companyId',
...
function isBastionPauseResponse(value) {
    return (isWithinJsonSize(value, MAX_PUBLIC_DTO_BYTES) &&
...
function isBastionRestoreNowResponse(value) {
    return (isWithinJsonSize(value, MAX_PUBLIC_DTO_BYTES) &&
...
//# sourceMappingURL=bastionScheduleValidation.js.map