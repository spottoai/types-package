...
export type AzureBillingExportScopeType = 'subscription' | 'resourceGroup' | 'managementGroup' | 'billingAccount' | 'billingProfile' | 'invoiceSection' | 'department' | 'enrollmentAccount' | 'partnerCustomer';
/**
...
export type AzureManualOnboardingBillingExportDiscoveryWarningCode = 'scopeAccessDenied' | 'exportUnreadable' | 'storageAccessDenied' | 'storageUnreadable' | 'discoveryUnavailable' | 'resultTruncated';
...
export declare const AZURE_MANUAL_ONBOARDING_BILLING_EXPORT_DISCOVERY_LIMITS_V1: {
    readonly detectedSources: 50;
    readonly storageOptions: 50;
    readonly warnings: 20;
};
/**
...
export declare const AZURE_MANUAL_ONBOARDING_IMPORT_SCHEMA_VERSION: 1;
export declare const AZURE_MANUAL_ONBOARDING_IMPORT_KIND: "spotto.azure.manual-onboarding";
...
//# sourceMappingURL=azureManualOnboarding.d.ts.map