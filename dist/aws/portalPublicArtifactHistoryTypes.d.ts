...
export declare const AWS_PORTAL_PUBLIC_ARTIFACT_RELATIONSHIPS: {
    readonly 'resource-collection': {
        readonly logicalName: "resources.json.gz";
        readonly required: readonly [];
        readonly optional: readonly ["resource-collection-history"];
    };
    readonly 'account-summary': {
        readonly logicalName: "account-summary.json.gz";
        readonly required: readonly [];
        readonly optional: readonly ["account-summary-history", "account-summary-ai-cost-summary"];
    };
    readonly 'resource-collection-history': {
        readonly logicalNamePattern: "resources-history--{scope-generation-sha256}.json.gz";
        readonly required: readonly [];
        readonly optional: readonly [];
    };
    readonly 'account-summary-history': {
        readonly logicalNamePattern: "account-summary-history--{scope-sha256}.json.gz";
        readonly required: readonly [];
        readonly optional: readonly [];
    };
    readonly 'account-summary-ai-cost-summary': {
        readonly logicalName: "account-summary-ai-cost-summary.json.gz";
...
interface AwsPortalHistoryEnvelope<ArtifactType extends 'resource-collection-history' | 'account-summary-history', AccountId extends string, RunId extends string> extends AwsPublicArtifactForbiddenCredentialFields {
    schemaVersion: 1;
    ...
    generatedAt: string;
    logicalName: ArtifactType extends 'resource-collection-history' ? AwsPortalResourceCollectionHistoryLogicalName : AwsPortalAccountSummaryHistoryLogicalName;
}
export type AwsPortalResourceCollectionHistoryArtifact<AccountId extends string = string, RunId extends string = string> = AwsPortalHistoryEnvelope<'resource-collection-history', AccountId, RunId> & {
...
export type AwsPortalAccountSummaryHistoryArtifact<AccountId extends string = string, RunId extends string = string> = AwsPortalHistoryEnvelope<'account-summary-history', AccountId, RunId> & {
...
export interface AwsPortalAccountSummaryAiCostSummaryEntry {
    ...
    provider: {
        ...
        trace?: {
            guardrailActionReason?: string;
            invokedModelId?: string;
        };
    };
}
export type AwsPortalAccountSummaryAiCostSummaryArtifact<AccountId extends string = string, RunId extends string = string> = AwsPublicArtifactEnvelope<'account-summary-ai-cost-summary', AccountId, RunId> & {
    portalSchemaVersion: 1;
    generatedAt: string;
