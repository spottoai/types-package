...
export type AwsPluginDeclaredSectionEvidence = AwsPluginAccountSummaryEvidence | AwsPluginResourceSummaryEvidence | AwsPluginAiCostSummaryEvidence | AwsPluginSubscriptionLifecycleEvidence | AwsPluginResourceLifecycleEvidence | AwsPluginSubscriptionRecommendationsEvidence | AwsPluginResourceRecommendationsEvidence | AwsPluginCommitmentEvidence | AwsPluginReliabilityEvidence | AwsPluginGovernanceEvidence | {
    item: AwsPluginResourceItemEvidence;
} | AwsPluginRelationshipEvidence;
export {};
//# sourceMappingURL=pluginPublicArtifactEvidence.d.ts.map