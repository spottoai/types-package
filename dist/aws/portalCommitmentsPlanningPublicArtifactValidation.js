...
exports.validateAwsPortalCommitmentsPlanningArtifact = validateAwsPortalCommitmentsPlanningArtifact;
const commitmentsPlanningValidation_js_1 = require("./commitmentsPlanningValidation.js");
const portalCommitmentsPlanningPublicArtifacts_js_1 = require("./portalCommitmentsPlanningPublicArtifacts.js");
...
function validateAwsPortalCommitmentsPlanningArtifact(value) {
    const artifact = (0, portalPublicArtifactValidationCommon_js_1.asRecord)(value, 'artifact');
    const { accountId } = (0, portalPublicArtifactValidationCommon_js_1.validatePortalEnvelope)(artifact, 'commitments-planning', TOP_LEVEL_KEYS);
    (0, portalPublicArtifactValidationCommon_js_1.assertValue)(artifact.logicalName, portalCommitmentsPlanningPublicArtifacts_js_1.AWS_PORTAL_COMMITMENTS_PLANNING_LOGICAL_NAME, 'artifact.logicalName');
    (0, commitmentsPlanningValidation_js_1.validateAwsCommitmentsPlanningViewIdentity)(artifact, accountId);
...
function optionalOpenRecord(value, field) {
    if (value !== undefined)
        (0, portalPublicArtifactValidationCommon_js_1.asRecord)(value, field);
}
function optionalMoney(value, field) {
    if (value !== undefined)
        validateMoney(value, field);
}
//# sourceMappingURL=portalCommitmentsPlanningPublicArtifactValidation.js.map