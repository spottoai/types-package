...
export declare const AWS_PORTAL_COMMITMENTS_PLANNING_LOGICAL_NAME: "commitments-planning.json.gz";
/** Immutable, exact-account AWS Commitments Planning Portal artifact. */
export type AwsPortalCommitmentsPlanningArtifact<AccountId extends string = string, RunId extends string = string> = AwsPublicArtifactEnvelope<'commitments-planning', AccountId, RunId> & {
...
//# sourceMappingURL=portalCommitmentsPlanningPublicArtifacts.d.ts.map