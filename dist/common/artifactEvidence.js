...
const isArtifactDependencyDescriptor = (value) => {
    ...
    if (value.digest !== undefined && (typeof value.digest !== 'string' || !SHA256_PATTERN.test(value.digest)))
        return false;
    if (!(0, artifactEvidenceValidation_js_1.hasValidOptionalArtifactRevisionComponents)(value))
        return false;
    ...
    if (value.emptyEvidence === 'complete-empty') {
        if (value.attempt !== 'succeeded' ||
            ...
            !(0, artifactEvidenceValidation_js_1.isStrictLogicalArtifactReference)(value.emptyProofRef)) {
            return false;
        }
    }
...
const isArtifactPublicationDecision = (value) => {
    if (!isRecord(value) ||
...
exports.isArtifactPublicationDecision = isArtifactPublicationDecision;
/** Checks the provider-neutral ownership shape used by observe- and enforce-mode artifacts. */
const isArtifactOwnershipBinding = (value) => isRecord(value) &&
...
exports.isArtifactOwnershipBinding = isArtifactOwnershipBinding;
/** Checks that an ownership binding is valid for enforce-mode publication. */
const isEnforceableArtifactOwnershipBinding = (value) => (0, exports.isArtifactOwnershipBinding)(value) && value.ownershipEpochRevision !== undefined;
exports.isEnforceableArtifactOwnershipBinding = isEnforceableArtifactOwnershipBinding;
/**
 ...
 */
const compareArtifactRevisionVector = (left, right) => {
