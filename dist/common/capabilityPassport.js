...
const isCapabilityPassport = (value) => {
    if (!isRecord(value) || value.schemaVersion !== exports.CAPABILITY_PASSPORT_SCHEMA_VERSION)
        return false;
...
exports.isCapabilityPassport = isCapabilityPassport;
//# sourceMappingURL=capabilityPassport.js.map