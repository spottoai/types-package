export declare const COMPANY_NOTE_SCHEMA_VERSION: 1;
export declare const COMPANY_NOTES_FEATURE_KEY: "company_notes";
export declare const COMPANY_NOTES_VIEW_PERMISSION_KEY: "company_notes.view";
export declare const COMPANY_NOTES_MANAGE_PERMISSION_KEY: "company_notes.manage";
export declare const COMPANY_NOTES_PERMISSION_KEYS: readonly ["company_notes.view", "company_notes.manage"];
export declare const COMPANY_NOTE_ORDINARY_CATEGORIES: readonly ["general", "meeting"];
export declare const COMPANY_NOTE_CONTEXT_CATEGORIES: readonly ["company-profile", "security", "architecture", "operations", "finops", "performance", "reliability", "roadmap"];
export declare const COMPANY_NOTE_CONTEXT_CATEGORY_ORDER: readonly ["company-profile", "security", "architecture", "operations", "finops", "performance", "reliability", "roadmap"];
export declare const COMPANY_NOTE_CATEGORIES: readonly ["general", "meeting", "company-profile", "security", "architecture", "operations", "finops", "performance", "reliability", "roadmap"];
export declare const COMPANY_NOTE_MEETING_TEMPLATE_KEY: "meeting-v1";
export declare const COMPANY_NOTE_CONTEXT_TEMPLATE_KEYS: readonly ["company-profile-v1", "security-v1", "architecture-v1", "operations-v1", "finops-v1", "performance-v1", "reliability-v1", "roadmap-v1"];
export declare const COMPANY_NOTE_TEMPLATE_KEYS: readonly ["meeting-v1", "company-profile-v1", "security-v1", "architecture-v1", "operations-v1", "finops-v1", "performance-v1", "reliability-v1", "roadmap-v1"];
export declare const COMPANY_NOTES_AI_MODES: readonly ["general-note", "template-draft", "section-draft", "coach-selection", "company-research"];
export declare const COMPANY_NOTES_AI_SOURCE_MODES: readonly ["spotto-only", "public-research"];
...
export type SaveCompanyNoteRequest = (SaveCompanyNoteRequestBase & {
    category?: CompanyNoteOrdinaryCategory;
    templateKey?: CompanyNoteMeetingTemplateKey;
    templateVersion?: number;
    content: CompanyNoteTipTapContent;
...
export type CompanyNotesAITemplateResponse = (CompanyNotesAITemplateResponseBase & {
