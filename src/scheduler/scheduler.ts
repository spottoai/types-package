/** Scheduler contracts that are not part of resource-strategy scheduling. */
export type ScheduleTargetType = 'recommendation-action' | 'provider-scope-operation';
...
export interface ScheduleListResponse {
  ...
  continuation?: { nextScheduleId?: string };
}
