import type {
  ...
  ResourceSchedulingCapabilityRef,
...
export type RecommendationActionScheduleTarget =
  ...
  | { selectorType: 'selected-resources'; resourceIds: string[] }
...
export type SchedulerOperationResult =
  | { resultType: 'capabilities'; capabilities: ResourceSchedulingCapabilityProjection[] }
  | { resultType: 'schedule'; schedule: ScheduleProjection }
  | { resultType: 'deleted' }
  | { resultType: 'readiness'; readiness: ResourceSchedulingReadinessProjection }
  | { resultType: 'preview'; preview: ResourceSchedulePreviewResponse };
...
export type SchedulerOperationProjection =
