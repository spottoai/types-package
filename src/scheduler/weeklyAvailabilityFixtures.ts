import type { ResourceScheduleTransition, ResourceScheduleWeekday, ResourceStrategyWeeklyRule } from './resourceStrategy';
...
): ResourceStrategyWeeklyRule => ({ ruleId, daysOfWeek, desiredStateAtLocal, transition });

const fixtures: WeeklyAvailabilityFixtureV1[] = [
  {
    ...
    periods: [1, 2, 3, 4, 5].map(day => ({
      ...
      start: { dayOfWeek: day as ResourceScheduleWeekday, timeLocal: '08:00' },
      end: { dayOfWeek: day as ResourceScheduleWeekday, timeLocal: '18:00' },
    })),
...
export const WEEKLY_AVAILABILITY_FIXTURES_V1: readonly WeeklyAvailabilityFixtureV1[] = deepFreeze(fixtures);
