import { AWS_FORBIDDEN_CREDENTIAL_FIELDS, type AwsForbiddenCredentialFields } from './requests';

/** Schema version for the API-owned AWS company estate manifest. */
export const AWS_ESTATES_MANIFEST_SCHEMA_VERSION = 1 as const;
 ...
 */
export interface AwsEstateAccountMembership<TCompanyId extends string = string, TEstateId extends string = string, TAccountId extends string = string>
  extends AwsEstatesManifestForbiddenCredentialFields {
  schemaVersion: 1;
...
export interface AwsEstateExcludedAccount<TCompanyId extends string = string, TEstateId extends string = string>
  extends AwsEstatesManifestForbiddenCredentialFields {
  schemaVersion: 1;
  companyId: TCompanyId;
  estateId: TEstateId;
...
export type AwsEstateBillingExport<TDefinitionAccountId extends string = string> =
  | AwsEstateCurBillingExport
  | AwsEstateDataExportsBillingExport<TDefinitionAccountId>;
 ...
 */
export interface AwsEstateBillingSource<
  TCompanyId extends string = string,
  TEstateId extends string = string,
  TAccountId extends string = string,
  TDefinitionRoleAccountId extends TAccountId = TAccountId,
  TStorageRoleAccountId extends TAccountId = TAccountId,
> extends AwsEstatesManifestForbiddenCredentialFields {
  schemaVersion: 1;
  companyId: TCompanyId;
  estateId: TEstateId;
...
export interface AwsEstateOrganization<TCompanyId extends string = string, TEstateId extends string = string, TAccountId extends string = string>
  extends AwsEstatesManifestForbiddenCredentialFields {
  schemaVersion: 1;
  companyId: TCompanyId;
  estateId: TEstateId;
...
interface AwsEstateBase<TCompanyId extends string, TEstateId extends string, TAccountId extends string>
  extends AwsEstatesManifestForbiddenCredentialFields {
  schemaVersion: 1;
  companyId: TCompanyId;
  estateId: TEstateId;
...
export interface AwsStandaloneEstate<TCompanyId extends string = string, TEstateId extends string = string, TAccountId extends string = string>
  extends AwsEstateBase<TCompanyId, TEstateId, TAccountId> {
  kind: 'standalone';
  organization?: never;
}

export interface AwsOrganizationEstate<TCompanyId extends string = string, TEstateId extends string = string, TAccountId extends string = string>
  extends AwsEstateBase<TCompanyId, TEstateId, TAccountId> {
  kind: 'organization';
  organization: AwsEstateOrganization<TCompanyId, TEstateId, TAccountId>;
}

export type AwsEstate<TCompanyId extends string = string, TEstateId extends string = string, TAccountId extends string = string> =
  | AwsStandaloneEstate<TCompanyId, TEstateId, TAccountId>
  | AwsOrganizationEstate<TCompanyId, TEstateId, TAccountId>;
