...
export const AWS_PORTAL_RELATIONSHIP_LOGICAL_NAME = 'relationships.json.gz' as const;
export const AWS_PORTAL_RELATIONSHIP_SCHEMA_VERSION = 2 as const;
...
export type AwsPortalRelationshipFamilyCoverage =
...
export type AwsPortalRelationshipStats = AwsPortalRelationshipStatsBase &
  (
    | { truncated: false; truncation?: never }
    | {
        truncated: true;
        truncation: {
...
export type AwsPortalRelationshipArtifactV2<AccountId extends string = string, RunId extends string = string> = AwsPublicArtifactEnvelope<
  'relationships',
  AccountId,
  RunId
> & {
...
export type AwsPortalRelationshipArtifactV1<AccountId extends string = string, RunId extends string = string> = AwsPublicArtifactEnvelope<
  'relationships',
  AccountId,
  RunId
> & {
...
export type AwsPortalRelationshipLegacyArtifact<AccountId extends string = string, RunId extends string = string> = AwsPortalRelationshipArtifactV1<
  AccountId,
  RunId
>;

/** Current lossless AWS relationship artifact. */
export type AwsPortalRelationshipArtifact<AccountId extends string = string, RunId extends string = string> = AwsPortalRelationshipArtifactV2<
  AccountId,
  RunId
>;
