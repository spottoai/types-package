import type {
  AwsPortalBillingCostAggregate,
  AwsPortalRecommendationActionHealth,
  AwsPortalRecommendationSource,
  AwsPortalRecommendationSourceEvidence,
...
export interface AwsPortalBillingCostView {
  ...
  commitmentCoverageState:
    ...
    | 'no-amortized-cost'
    | 'no-delta'
    | 'amortized-exceeds-base'
    | 'partial-amortized-cost'
    | 'amortization-coverage-unavailable';
