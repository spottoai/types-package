...
import type {
  ...
  CommitmentsExpirySummary,
  CommitmentsFreshnessStatus,
  CommitmentsFreshnessSummary,
  CommitmentsInventoryStatus,
  CommitmentsMoneyAmount,
  CommitmentsPricingContext,
  CommitmentsRiskLevel,
...
export const AWS_ORGANIZATION_COMMITMENTS_REFRESH_STATES = ['not-started', 'pending', 'processing', 'fresh', 'partial', 'failed'] as const;

export const AWS_ORGANIZATION_COMMITMENTS_REFRESH_STAGE_STATUSES = ['pending', 'processing', 'fresh', 'partial', 'failed', 'skipped'] as const;
...
export const AWS_ORGANIZATION_COMMITMENTS_ATTRIBUTION_UNAVAILABLE_REASONS = ['not-collected', 'not-proved', 'source-unavailable'] as const;
...
export const AWS_ORGANIZATION_COMMITMENTS_SESSION_ID_PREFIX = 'aws-org-commitments:' as const;
...
export interface AwsOrganizationCommitmentsPlanningReadScope<
  CompanyId extends string = string,
  EstateId extends string = string,
  OrganizationId extends string = string,
  ManagementAccountId extends string = string,
> extends AwsOrganizationCommitmentsForbiddenFields {
  provider: 'AWS';
...
export interface AwsOrganizationCommitmentsPlanningProviderScope<
  CompanyId extends string = string,
  EstateId extends string = string,
  OrganizationId extends string = string,
  ManagementAccountId extends string = string,
...
export type AwsOrganizationCommitmentsAllocationEvidence<AccountId extends string = string> =
  | AwsOrganizationCommitmentsUnavailableEvidence
  | AwsOrganizationCommitmentsAvailableEvidence<AwsOrganizationCommitmentsAllocationRecord<AccountId>>;

export type AwsOrganizationCommitmentsResourceAttributionEvidence<AccountId extends string = string> =
  | AwsOrganizationCommitmentsUnavailableEvidence
  | AwsOrganizationCommitmentsAvailableEvidence<AwsOrganizationCommitmentsResourceAttributionRecord<AccountId>>;

export interface AwsOrganizationCommitmentsPlanningView<
  CompanyId extends string = string,
  EstateId extends string = string,
  OrganizationId extends string = string,
...
function requiredSessionIdentity(value: string, field: string): string {
