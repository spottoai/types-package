...
export const AWS_REQUEST_SCHEMA_VERSION = 1 as const;

/** Canonical provider wire value for AWS request messages. */
export const AWS_REQUEST_PROVIDER = 'aws' as const;

/** Entity handled by the first AWS Service Bus ingress contract. */
export const AWS_REQUEST_ENTITY = 'cloudaccount' as const;

/** Actions supported by the first AWS Service Bus ingress contract. */
export const AWS_REQUEST_ACTIONS = ['onboard', 'refresh', 'delete'] as const;

/** Credential-shaped keys rejected at the AWS request boundary. */
export const AWS_REQUEST_FORBIDDEN_CREDENTIAL_FIELDS = [
  'accessKeyId',
  'secretAccessKey',
  'sessionToken',
  'credentials',
