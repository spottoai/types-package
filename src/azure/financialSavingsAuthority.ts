...
export const FINANCIAL_ELIGIBILITY_ASSESSMENT_SCHEMA_VERSION_V1 = 1 as const;
export const FINANCIAL_ELIGIBILITY_ASSESSMENT_CONTRACT_VERSION_V1 = 'financial-eligibility-assessment/v1' as const;

export type FinancialEligibilityBenefitKindV1 = 'savings-plan' | 'reservation' | 'licence' | 'other';
export type FinancialEligibilityUnavailableReasonV1 =
...
export type FinancialEligibilityAssessmentIdentityPreimageV1 =
  | Omit<AvailableFinancialEligibilityAssessmentV1, 'eligibilityId'>
  | Omit<UnavailableFinancialEligibilityAssessmentV1, 'eligibilityId'>;
...
export type FinancialSavingsLifecycleStateV1 =
  | 'Active'
  | 'Prioritized'
  | 'Dismissed'
  | 'Archived'
...
export type FinancialSavingsActivationReasonV1 =
  | 'active'
  | 'prioritized'
  | 'dismissal-expired'
  | 'implementing'
