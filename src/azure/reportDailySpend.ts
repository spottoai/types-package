 ...
 * No estimates, resource breakdowns or currency conversion. Missing dates/amounts are not zero.
...
export interface ReportDailySpend {
  ...
  /** At least one finite amount per entry. Emit zero only with confirmed source coverage. */
