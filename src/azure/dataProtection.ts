export const DATA_PROTECTION_SCHEMA_VERSION = '2026-06-24' as const;
export const DATA_PROTECTION_SOURCE = 'Spotto.DataProtectionPosture' as const;

export const DATA_PROTECTION_PORTAL_FILE = 'data-protection.json.gz' as const;
export const DATA_PROTECTION_BACKUP_COST_DIAGNOSTICS_FILE = 'data-protection/backup-costs.json.gz' as const;
export const DATA_PROTECTION_BILLING_SOURCE_FILE = 'history/billing/cost-last-30-days.json' as const;
...
export type DataProtectionCostAllocationMethod =
  | 'direct'
  | 'protectedDataSizeWeighted'
  | 'backupStorageWeighted'
  | 'resourceSizeWeighted'
  | 'evenSplit';
...
export type DataProtectionFinding =
  ...
  | 'protection_error'
  | 'policy_inconsistent'
  | 'native_backup_retention_gap'
  | 'backup_job_alerts_disabled'
  | 'backup_cost_unavailable'
