export const REGULATORY_COMPLIANCE_REPORT_SCHEMA_VERSION = '2026-07-29.regulatory-compliance-v1' as const;
export const REGULATORY_COMPLIANCE_ASSIGNMENT_DETAIL_SCHEMA_VERSION = '2026-07-29.regulatory-compliance-assignment-v1' as const;
export const POLICY_EXEMPTION_COMMAND_SCHEMA_VERSION = '2026-07-29.policy-exemption-command-v1' as const;
export const REGULATORY_COMPLIANCE_PORTAL_FILE = 'regulatory-compliance.json.gz' as const;
export const REGULATORY_COMPLIANCE_ASSIGNMENT_DETAIL_DIRECTORY = 'regulatory-compliance/assignments' as const;

export type PolicyExemptionCommandSchemaVersion = typeof POLICY_EXEMPTION_COMMAND_SCHEMA_VERSION;

export type AzurePolicyEvaluationState =
  | 'compliant'
  | 'nonCompliant'
  | 'exempt'
  | 'error'
