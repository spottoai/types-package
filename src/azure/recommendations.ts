...
import type {
  CostSavingsAggregationPolicy,
  CostSavingsSpendBasis,
  CostSavingsSummary,
  CurrencySavingsGroup,
  SavingsPotential,
  VmPricePerformanceInsights,
} from './views';
...
export type RecommendationKnownRenderData =
  | HddOsRetirementRenderStrategyPayload
  | VmPricePerformanceInsights
  | LicensingRecommendationRenderData
  | ReservedInstanceRecommendationRenderData;
...
export const RECOMMENDATION_LIFECYCLE_OVERLAY_SCHEMA_VERSION_V2 = 2 as const;
export const RECOMMENDATION_LIFECYCLE_OVERLAY_CONTRACT_VERSION_V2 = 'recommendation-lifecycle-overlay/v2' as const;
...
export type RecommendationLifecycleOverlayV2 =
  | CompleteRecommendationLifecycleOverlayV2
  | PartialRecommendationLifecycleOverlayV2
  | UnavailableRecommendationLifecycleOverlayV2;

export type RecommendationLifecycleOverlayIdentityPreimageV2 = RecommendationLifecycleOverlayV2 extends infer Overlay
  ? Overlay extends RecommendationLifecycleOverlayV2
    ? Omit<Overlay, 'overlayId'>
    : never
  : never;
