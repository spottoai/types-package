...
export const FINANCIAL_RESOURCE_SURFACE_PROJECTION_SCHEMA_VERSION_V1 = 1 as const;
export const FINANCIAL_RESOURCE_SURFACE_PROJECTION_CONTRACT_VERSION_V1 =
  'financial-resource-surface-projection/v1' as const;

export type FinancialResourceRoleV1 = 'owner' | 'display-only' | 'unclassified';

export type FinancialResourceSurfaceValueV1 = FinancialSurfaceMoneyV1 & { coordinateId: string };
...
export type FinancialResourceScenarioV1 =
  | AvailableFinancialResourceScenarioV1
  | PartialFinancialResourceScenarioV1
  | UnavailableFinancialResourceScenarioV1;
