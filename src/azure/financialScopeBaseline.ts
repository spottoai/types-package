...
export interface FinancialOwnerBaselineComponentV2 {
  ...
  effectiveRate?: { amount: string; unit: string; currencyCode: string };
}
...
export type FinancialScopeBaselineEnvelopeV2 =
  | AvailableOwnerFinancialScopeBaselineV2
  | AvailableAggregateFinancialScopeBaselineV2
  | UnavailableFinancialScopeBaselineV2;

export type FinancialOwnerBaselineIdentityPreimageV2 = Omit<
  AvailableOwnerFinancialScopeBaselineV2,
  'status' | 'baselineId' | 'total' | 'reconciliation'
>;

export type FinancialAggregateBaselineIdentityPreimageV2 = Omit<
  AvailableAggregateFinancialScopeBaselineV2,
  'status' | 'baselineId' | 'total' | 'reconciliation'
>;
