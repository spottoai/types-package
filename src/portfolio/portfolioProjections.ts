import type {
  ...
  PortfolioReportRow,
  PortfolioSowRow,
} from './portfolioOperations';

export const PORTFOLIO_PROJECTION_PREVIOUS_SCHEMA_VERSION = '2026-07-26' as const;
export const PORTFOLIO_PROJECTION_SCHEMA_VERSION = '2026-08-02' as const;
...
export const PORTFOLIO_CLOUD_ACCOUNT_SUMMARY_SCHEMA_VERSION = '2026-07-27' as const;
