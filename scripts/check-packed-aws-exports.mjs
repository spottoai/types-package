...
try {
  ...
  run(
    ...
    [
      '--input-type=module',
      '-e',
      "import root from '@spottoai/types-package'; import * as scheduler from '@spottoai/types-package/scheduler'; const tick = root.createResourceSchedulerTickRequestMessageV1('2026-09-16T00:00:00.000Z'); if (typeof root.isResourceSchedulerTickRequestMessageV1 !== 'function' || !root.isResourceSchedulerTickRequestMessageV1(tick) || typeof root.isResourceScheduleDryRunProjection !== 'function' || typeof scheduler.isResourceScheduleDryRunProjection !== 'function' || typeof root.isResourceStrategyWeeklyScheduleWriteRequest !== 'function' || typeof root.isResourceStrategyWeeklyScheduleSuggestion !== 'function' || typeof scheduler.isResourceStrategyWeeklyScheduleWriteRequest !== 'function' || typeof scheduler.isResourceStrategyWeeklyScheduleSuggestion !== 'function' || !Array.isArray(scheduler.WEEKLY_AVAILABILITY_FIXTURES_V1) || 'isBastionAvailabilityWeeklyScheduleDefinition' in scheduler) process.exit(1);",
    ],
    consumerRoot
  );
  run(
